...
public class ApiTests {
    ...
    public void getCategories() {
        ...
        response.log()
                ...
                .body("response.price", everyItem(notNullValue()))
                .body("response.category_id", everyItem(notNullValue()))
                .body("response.category_name", everyItem(notNullValue()))
    ...
    public void getProduct() {
        ...
        response.assertThat().statusCode(200)
                ...
                .body("description", equalTo("The most awsome phone of 2013!"))
    ...
    public void createProduct() {
        ...
        String body = """
                {
                "name": "Water Bottle",
                "description": "Blue waterbottle; Holds 64 liters",
                "price": 12,
                "category_id": 3
                }
                """;
    ...
    public void createSerializedProduct() {
        String endpoint = "http://localhost:3306/api_testing/product/create.php";
        Product product = new Product("Water Bottle", "Blue Water Bottle", 13, 3);
        var response = given().body(product).when().post(endpoint).then();
        response.log().body();
    }

    @Test
    public void getDeserializedProducts() {
        String endpoint = "http://localhost:3306/api_testing/product/read_one.php";
        Product expectedProduct = new Product(2,
                "Cross-Back Training Tank",
                "The most awsome phone of 2013!",
                299.00,
                2,
                "Active Wear - Women");
